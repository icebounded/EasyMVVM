...
import pers.icebounded.lib.R
import pers.icebounded.lib.ext.throttleClick
import pers.icebounded.lib.statelayout.StateLayout.Status
import pers.icebounded.lib.statelayout.StateLayout.Status.*
...
class StateLayout @JvmOverloads constructor(
    ...
    init {
        val attributes = context.obtainStyledAttributes(attrs, R.styleable.base_StateLayout)
        try {
            emptyLayout = attributes.getResourceId(R.styleable.base_StateLayout_base_empty_layout, NO_ID)
            errorLayout = attributes.getResourceId(R.styleable.base_StateLayout_base_error_layout, NO_ID)
            loadingLayout = attributes.getResourceId(R.styleable.base_StateLayout_base_loading_layout, NO_ID)
        } finally {
            attributes.recycle()
        }
    }
            ...
            try {
                ...
                when (layoutId) {
                    ...
                    emptyLayout -> {
                        ...
                        onEmpty = onEmpty ?: StateConfig.onEmpty
                    ...
                    errorLayout -> {
                        ...
                        onError = onError ?: StateConfig.onError
                    ...
                    loadingLayout -> {
                        ...
                        onLoading = onLoading ?: StateConfig.onLoading
